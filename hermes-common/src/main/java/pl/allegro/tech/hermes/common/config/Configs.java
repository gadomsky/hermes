...
public enum Configs {
    ...
    SCHEMA_REPOSITORY_AUTHORIZATION_ENABLED("schema.repository.authorization.enabled", false),
    SCHEMA_REPOSITORY_AUTHORIZATION_USERNAME("schema.repository.authorization.username", ""),
    SCHEMA_REPOSITORY_AUTHORIZATION_PASSWORD("schema.repository.authorization.password", ""),
