...
public enum Configs {
    ...
    KAFKA_SSL_KEY_PASSWORD("kafka.ssl.key.password", null),
    KAFKA_SSL_KEYSTORE_CERTIFICATE_CHAIN("kafka.ssl.keystore.certificate.chain", null),
    KAFKA_SSL_KEYSTORE_KEY("kafka.ssl.keystore.key", null),
    KAFKA_SSL_KEYSTORE_LOCATION("kafka.ssl.keystore.location", null),
    KAFKA_SSL_KEYSTORE_PASSWORD("kafka.ssl.keystore.password", null),
    KAFKA_SSL_TRUSTSTORE_CERTIFICATES("kafka.ssl.truststore.certificates", null),
    KAFKA_SSL_TRUSTSTORE_LOCATION("kafka.ssl.truststore.location", null),
    KAFKA_SSL_TRUSTSTORE_PASSWORD("kafka.ssl.truststore.password", null),
    KAFKA_SSL_ENABLED_PROTOCOLS("kafka.ssl.enabled.protocols", null),
    KAFKA_SSL_KEYSTORE_TYPE("kafka.ssl.keystore.type", "JKS"),
    KAFKA_SSL_PROTOCOL("kafka.ssl.protocol", "TLSv1.2"),
    KAFKA_SSL_PROVIDER("kafka.ssl.provider", null),
    KAFKA_SSL_TRUSTSTORE_TYPE("kafka.ssl.truststore.type", "JKS"),
    KAFKA_SSL_CIPHER_SUITES("kafka.ssl.cipher.suites", null),
    KAFKA_SSL_ENDPOINT_IDENTIFICATION_ALGORITHM("kafka.ssl.endpoint.identification.algorithm", "https"),
    KAFKA_SSL_ENGINE_FACTORY_CLASS("kafka.ssl.engine.factory.class", null),
    KAFKA_SSL_KEYMANAGER_ALGORITHM("kafka.ssl.keymanager.algorithm", "SunX509"),
    KAFKA_SSL_SECURE_RANDOM_IMPLEMENTATION("kafka.ssl.secure.random.implementation", null),
    KAFKA_SSL_TRUSTMANAGER_ALGORITHM("kafka.ssl.trustmanager.algorithm", "PKIX"),
